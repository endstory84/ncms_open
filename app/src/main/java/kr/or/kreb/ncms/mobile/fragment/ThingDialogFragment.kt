...
//        thingKndDetailListView.adapter = thingAdapterKndDetailAdapter
    ...
    fun subListInput() {
        treeSubList.add(R.string.thingTreeAll)
        treeSubList.add(R.string.thingTree00)
        treeSubList.add(R.string.thingTree11)
        treeSubList.add(R.string.thingTree26)
        treeSubList.add(R.string.thingTree27)
        treeSubList.add(R.string.thingTree28)
        treeSubList.add(R.string.thingTree29)
        treeSubList.add(R.string.thingTree30)
        treeSubList.add(R.string.thingTree31)
        treeSubList.add(R.string.thingTree36)
        treeSubList.add(R.string.thingTree41)
        treeSubList.add(R.string.thingTree42)
        treeSubList.add(R.string.thingTree43)
        treeSubList.add(R.string.thingTree44)
        treeSubList.add(R.string.thingTree45)
        treeSubList.add(R.string.thingTree46)
        treeSubList.add(R.string.thingTree47)
        treeSubList.add(R.string.thingTree48)
        treeSubList.add(R.string.thingTree50)

        buildSubList.add(R.string.buildSubAll)
        buildSubList.add(R.string.buildSubHouse)
        buildSubList.add(R.string.buildSubHanok)
        buildSubList.add(R.string.buildSubNewHanOk)
        buildSubList.add(R.string.buildSubLuxuryHouse)
        buildSubList.add(R.string.buildSubMulitHouse)
        buildSubList.add(R.string.buildSubApartment)
        buildSubList.add(R.string.buildSubComplexApartment)
        buildSubList.add(R.string.buildSubRowHouse)
        buildSubList.add(R.string.buildSubLuxuryRowHouse)
        buildSubList.add(R.string.buildSubMulitFamilyHouse)
        buildSubList.add(R.string.buildSubDormitory)
        buildSubList.add(R.string.buildSubStore)
        buildSubList.add(R.string.buildSubBath)
        buildSubList.add(R.string.buildSubSauna)
        buildSubList.add(R.string.buildSubWarehouse)
        buildSubList.add(R.string.buildSubColdStorage)
        buildSubList.add(R.string.buildSubFactory)
        buildSubList.add(R.string.buildSubRefrigenration)
        buildSubList.add(R.string.buildSubSemiconductor)
        buildSubList.add(R.string.buildSubApartmentFactory)
        buildSubList.add(R.string.buildSubMotel)
        buildSubList.add(R.string.buildSubHotel)
        buildSubList.add(R.string.buildSubCondHotel)
        buildSubList.add(R.string.buildSubCondVilla)
        buildSubList.add(R.string.buildSubGeneralBusiness)
        buildSubList.add(R.string.buildSubOfficetels)
        buildSubList.add(R.string.buildSubPublicBusiness)
        buildSubList.add(R.string.buildSubDepartment)
        buildSubList.add(R.string.buildSubDisCountStore)
        buildSubList.add(R.string.buildSubBowling)
        buildSubList.add(R.string.buildSubGym)
        buildSubList.add(R.string.buildSubLeisure)
        buildSubList.add(R.string.buildSubHospital)
        buildSubList.add(R.string.buildSubFuneral)
        buildSubList.add(R.string.buildSubBanquet)
        buildSubList.add(R.string.buildSubCinema)
        buildSubList.add(R.string.buildSubSchool)
        buildSubList.add(R.string.buildSubGas)
        buildSubList.add(R.string.buildSubParking)
        buildSubList.add(R.string.buildSubChurch)
        buildSubList.add(R.string.buildSubOccupancy)
        buildSubList.add(R.string.buildSubKindergarden)
        buildSubList.add(R.string.buildSubBarn)



        materialSubList.add(R.string.materialSubAll)
        materialSubList.add(R.string.materialSubStructural)
        materialSubList.add(R.string.materialSubRoofing)
        materialSubList.add(R.string.materialSubWall)
        materialSubList.add(R.string.materialSubFlooring)
        materialSubList.add(R.string.materialSubZenith)
        materialSubList.add(R.string.materialSubInsulator)
        materialSubList.add(R.string.materialSubWindow)
