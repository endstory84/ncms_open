...
class TombOwnerRecyclerViewAdapter  (
    val context: Context,
    ...
    inner class TombOwnerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
//        init{
...
//        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            else -> TombOwnerViewHolder(parent.inflate(R.layout.fragment_add_owner_item))
        }
