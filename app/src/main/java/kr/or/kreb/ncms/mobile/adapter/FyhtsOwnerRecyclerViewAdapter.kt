...
class FyhtsOwnerRecyclerViewAdapter (
    val context: Context,
    ...
    inner class FshrOwnerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
//        init{
...
//        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            else -> FshrOwnerViewHolder(parent.inflate(R.layout.fragment_add_owner_item))
        }
