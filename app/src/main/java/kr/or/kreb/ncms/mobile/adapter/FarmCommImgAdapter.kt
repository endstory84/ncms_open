...
class FarmCommImgAdapter (
    val activity: Activity?,
//    private val arrayList: ArrayList<Int>,
    var context: Context
    ) : RecyclerView.Adapter<FarmCommImgAdapter.FarmViewHolder>() {
...
//    var tempArr = mutableListOf<List<Temp>>()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FarmViewHolder {
        val view = FarmViewHolder(parent.inflate(R.layout.fragment_land_search_item2))
        return view
    }
