...
class MinrgtOwnerRecyclerViewAdapter (
    val context: Context,
    ...
    inner class MnidstOwnerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
//        init{
...
//        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            else -> MnidstOwnerViewHolder(parent.inflate(R.layout.fragment_add_owner_item))
        }
