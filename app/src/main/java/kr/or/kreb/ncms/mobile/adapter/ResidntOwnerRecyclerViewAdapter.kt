...
class ResidntOwnerRecyclerViewAdapter  (
    val context: Context,
    ...
    inner class ResidntOwnerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
//        init{
...
//        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            else -> ResidntOwnerViewHolder(parent.inflate(R.layout.fragment_add_owner_item))
        }
