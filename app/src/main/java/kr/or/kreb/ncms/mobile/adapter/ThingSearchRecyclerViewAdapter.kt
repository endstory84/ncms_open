...
class ThingSearchRecyclerViewAdapter : RecyclerView.Adapter<ThingSearchRecyclerViewAdapter.ThingSearchViewHolder>() {
        //임시 item
    ...
    inner class ThingSearchViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ThingSearchViewHolder {

        return ThingSearchViewHolder(parent.inflate(R.layout.thing_search_gnrl_item))
    }

    override fun onBindViewHolder(holder: ThingSearchViewHolder, position: Int) {

        when (holder) {
            is ThingSearchViewHolder -> {
