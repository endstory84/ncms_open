...
class BsnOwnerRecyclerViewAdapter (
    val context: Context,
    ...
    inner class BsnOwnerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
//        init{
...
//        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            else -> BsnOwnerViewHolder(parent.inflate(R.layout.fragment_add_owner_item))
        }
