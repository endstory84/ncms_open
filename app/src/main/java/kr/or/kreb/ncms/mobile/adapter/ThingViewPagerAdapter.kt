...
import kr.or.kreb.ncms.mobile.fragment.ThingOwnerFragment
import kr.or.kreb.ncms.mobile.fragment.ThingSearchFragment

class ThingViewPagerAdapter(
    ...
    override fun createFragment(position: Int): Fragment {
        ...
        return when (position) {
            search -> ThingSearchFragment(activity, context, fragmentActivity)
            else -> ThingOwnerFragment(fragmentActivity)
        }
    }
}